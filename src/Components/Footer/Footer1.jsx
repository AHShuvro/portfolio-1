            ...
            <div className="container flex flex-1 flex-col py-20 md:py-20 lg:py-24 xl:py-[10.5rem]">
                ...
                <div className="flex flex-col lg:flex-col xl:flex-row justify-between items-start xl:items-center ">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <p className=" text-[1.15rem] md:text-[1.37rem] lg:text-[1.62rem] text-white font-poppins font-light">ahshuvro77777@gmail.com</p>
                    </div>
                    <div className="">
                        <button className=" p-2 md:p-3 lg:p-5 rounded-full border-[0.1rem] active:bg-slate-50 text-white active:text-black border-[#3b3d49] mr-4"><FaLinkedinIn />
                        </button>
                        <button className=" p-2 md:p-3 lg:p-5 rounded-full border-[0.1rem] active:bg-slate-50 text-white active:text-black border-[#3b3d49]"><RiGithubFill />
                        </button>
                    </div>
                </div>
            </div>
