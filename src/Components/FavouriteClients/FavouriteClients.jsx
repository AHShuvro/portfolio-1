        ...
        <>
            ...
            <div className='container mx-auto my-20 md:my-20 lg:my-24 xl:my-[10.5rem]'>
                <div>
                    ...
                    <h2 className=' text-[#fff] text-[4.37rem] font-bold mt-4'>Work With Trusted Comapny.</h2>
                </div>
                <div className='flex justify-between mt-[7.5rem]'>
                    ...
                    >
                        <SwiperSlide>
                            <div className='h-[13.75rem] hover:bg-[#252734] transition-all duration-500 rounded-lg border-[0.0625rem] border-[#353743]'>
