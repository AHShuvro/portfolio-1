            ...
            <div className='bg-[#252734] py-20 md:py-20 lg:py-24 xl:py-[10.5rem]'>
                <div className='flex items-center justify-between container '>
                    <div className='flex flex-col items-start justify-center'>
                        ...
                        <p className='text-[#858792] font-poppins sm:text-[1rem] md:text-[1.12rem] lg:text-[1.37rem] xl:text-[1.37rem]'>Front-end developer specializing in Shopify & Webflow.</p>
